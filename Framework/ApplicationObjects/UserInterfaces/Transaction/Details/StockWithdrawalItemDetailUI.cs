...
namespace NSites.ApplicationObjects.UserInterfaces.Transaction.Details
{
    public partial class StockWithdrawalItemDetailUI : Form
    {
        ...
        public StockWithdrawalItemDetailUI(string pDetailId, string pStockId, string pStockDescription, string pUnit, string pBrand, string pSupplier,
            string pPicture, string pLocationId, decimal pQtyOUT, decimal pBalance, decimal pUnitPrice, decimal pTotalPrice, string pRemarks)
        {
            InitializeComponent();
            loStock = new Stock();
            loLocation = new Location();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            lRecordData[10] = string.Format("{0:n}", decimal.Parse(txtBalance.Text));
            lRecordData[11] = string.Format("{0:n}", decimal.Parse(txtUnitPrice.Text));
